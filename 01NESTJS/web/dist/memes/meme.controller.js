...
let MemeController = class MemeController {
    ...
    async crearMemeFormualrio(response, parametrosCuerpo) {
        ...
        memeCrearDto.fechaCreacion = new Date(parametrosCuerpo.fechaCreacion);
    ...
    async actualizarMeme(response, parametrosCuerpo, parametrosRuta) {
        ...
        memeActualizarDto.fechaCreacion = new Date(parametrosCuerpo.fechaCreacion);
        ...
        try {
            ...
            if (errores.length > 0) {
                ...
                response.redirect('/meme/lista-memes' +
                    '?mensaje= Se actualizo el memea pelicula ' +
                    parametrosCuerpo.nombre);
            }
        }
        catch (error) {
...
], MemeController.prototype, "listaUsuarios", null);
__decorate([
...
__decorate([
    (0, common_1.Post)('actualizar-meme-formulario/:idMovie'),
    __param(0, (0, common_1.Res)()),
    __param(1, (0, common_1.Body)()),
